...
状态：Codex 第三版设计草案，等待独立只读复审。首稿和第二稿分别经 `qwen-code-review-20260925-072159-741e0c`、`qwen-code-review-20260925-074749-68ba6f` 判定为 NO-GO；第三版补上阻断实现的 M0 探针及逐入口门禁。此版将可执行本地 shell 移出 030A，先在 Windows 与 Linux 交付**真实的任务级文件工具边界**。文档不是功能完成证据。
