...
def build_app(server: OctopServer) -> FastAPI:
    ...
    _mount_routers(
        ...
        [
            ...
            _RouterMount(project_todos.router, "/api", ["projects"]),
            _RouterMount(project_tasks.router, "/api", ["projects"]),
            _RouterMount(project_task_files.router, "/api", ["projects"]),
            _RouterMount(project_activity.router, "/api", ["projects"]),
            _RouterMount(project_assets.router, "/api", ["projects"]),
